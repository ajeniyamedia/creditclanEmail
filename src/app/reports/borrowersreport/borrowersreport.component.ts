...
@Component({
  selector: 'app-borrowersreport',
  templateUrl: './borrowersreport.component.html',
  styleUrls: ['./borrowersreport.component.css']
})
export class BorrowersreportComponent implements OnInit {
    ...
    getLoans(){
        this.operationsService.getBorrowersReport(this.currentUser.token, this.filter).subscribe(data => {
