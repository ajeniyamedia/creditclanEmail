...
@Component({
  selector: 'app-defferedincomereport',
  templateUrl: './defferedincomereport.component.html',
  styleUrls: ['./defferedincomereport.component.css']
})
export class DefferedincomereportComponent implements OnInit {
