...
@Component({
  selector: 'app-missed-repayment',
  templateUrl: './missed-repayment.component.html',
  styleUrls: ['./missed-repayment.component.css']
})
export class MissedRepaymentComponent implements OnInit {
    ...
    getMissedLoans(){
        this.operationsService.getMissedRepayment(this.currentUser.token, this.filter).subscribe(data => {
