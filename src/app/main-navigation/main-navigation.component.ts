import { Component, OnInit, ElementRef, OnDestroy, ViewContainerRef } from '@angular/core';
...
export class MainNavigationComponent implements OnInit {
  ...
  constructor(private toastr: ToastrService,private DataService: DataService, 
    ...
    this.DataService.makeOfferToMarketLoan.subscribe(res => {
      ...
      this.loading=false;
      this.is_done='0' 
      this.offer = new OfferModel(res.REQUEST_ID,res.PLATFORM_ID,res.PEOPLE_ID,res.REQUEST_PRINCIPAL,res.REQUEST_TENOR,res.REQUEST_PERIOD_ID,res.REQUEST_RATE,res.REQUEST_RATE_PERIOD_ID,'1','3')
    })
  }
