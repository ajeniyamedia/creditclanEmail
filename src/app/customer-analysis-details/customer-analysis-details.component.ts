...
export class CustomerAnalysisDetailsComponent implements OnInit {
  ...
  subAnalytics :any;
  socialAnalysis:any;
  currentView: any= "personal_details";
  enable:any;
  constructor(
...
analysisSlider(){
  this.DataService.onOpenLoanChildModal.emit({'location': 'customer-analysis-slider', data : this.statement,social:this.socialAnalysis
});
}
sectionOpen = 'profile';
