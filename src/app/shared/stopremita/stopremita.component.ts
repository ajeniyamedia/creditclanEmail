...
@Component({
  selector: 'app-stopremita',
  templateUrl: './stopremita.component.html',
  styleUrls: ['./stopremita.component.css']
})
export class StopremitaComponent implements OnInit {
  ...
  doCancelRemitaInflight(value: any): void {
    this.makingFinalPayment = true;
    this.paymentHasBeenProcessed = false;
