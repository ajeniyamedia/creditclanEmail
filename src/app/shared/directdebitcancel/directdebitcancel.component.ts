...
@Component({
  selector: 'app-directdebitcancel',
  templateUrl: './directdebitcancel.component.html',
  styleUrls: ['./directdebitcancel.component.css']
})
export class DirectdebitcancelComponent implements OnInit {
