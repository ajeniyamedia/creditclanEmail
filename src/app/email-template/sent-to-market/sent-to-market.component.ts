...
@Component({
  selector: 'app-sent-to-market',
  templateUrl: './sent-to-market.component.html',
  styleUrls: ['./sent-to-market.component.css'],
  animations: [
    trigger('fade', [
      transition('void => *', [
        style({ opacity: 0 }),
...
export class SentToMarketComponent implements OnInit {
