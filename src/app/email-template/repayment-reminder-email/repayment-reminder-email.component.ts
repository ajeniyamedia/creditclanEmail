...
@Component({
  selector: 'app-repayment-reminder-email',
  templateUrl: './repayment-reminder-email.component.html',
  styleUrls: ['./repayment-reminder-email.component.css'],
  animations: [
    trigger('fade', [
      transition('void => *', [
        style({ opacity: 0 }),
...
export class RepaymentReminderEmailComponent implements OnInit {
