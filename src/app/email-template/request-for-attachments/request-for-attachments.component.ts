...
@Component({
  selector: 'app-request-for-attachments',
  templateUrl: './request-for-attachments.component.html',
  styleUrls: ['./request-for-attachments.component.css'],
  animations: [
    trigger('fade', [
      transition('void => *', [
        style({ opacity: 0 }),
...
export class RequestForAttachmentsComponent implements OnInit {
