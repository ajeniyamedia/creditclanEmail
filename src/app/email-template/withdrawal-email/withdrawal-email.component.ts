...
@Component({
  selector: 'app-withdrawal-email',
  templateUrl: './withdrawal-email.component.html',
  styleUrls: ['./withdrawal-email.component.css'],
  animations: [
    trigger('fade', [
      transition('void => *', [
        style({ opacity: 0 }),
...
export class WithdrawalEmailComponent implements OnInit {
