...
@Component({
  selector: 'app-borrower-accpected-offer-letter',
  templateUrl: './borrower-accpected-offer-letter.component.html',
  styleUrls: ['./borrower-accpected-offer-letter.component.css'],
  animations: [
    trigger('fade', [
      transition('void => *', [
        style({ opacity: 0 }),
...
export class BorrowerAccpectedOfferLetterComponent implements OnInit {
