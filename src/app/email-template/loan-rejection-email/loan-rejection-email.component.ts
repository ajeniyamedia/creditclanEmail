...
@Component({
  selector: 'app-loan-rejection-email',
  templateUrl: './loan-rejection-email.component.html',
  styleUrls: ['./loan-rejection-email.component.css'],
  animations: [
    trigger('fade', [
      transition('void => *', [
        style({ opacity: 0 }),
...
export class LoanRejectionEmailComponent implements OnInit {
