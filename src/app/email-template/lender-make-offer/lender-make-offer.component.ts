...
@Component({
  selector: 'app-lender-make-offer',
  templateUrl: './lender-make-offer.component.html',
  styleUrls: ['./lender-make-offer.component.css'],
  animations: [
    trigger('fade', [
      transition('void => *', [
        style({ opacity: 0 }),
...
export class LenderMakeOfferComponent implements OnInit {
