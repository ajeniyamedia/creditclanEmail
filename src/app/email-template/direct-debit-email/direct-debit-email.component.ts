...
@Component({
  selector: 'app-direct-debit-email',
  templateUrl: './direct-debit-email.component.html',
  styleUrls: ['./direct-debit-email.component.css'],
  animations: [
    trigger('fade', [
      transition('void => *', [
        style({ opacity: 0 }),
...
export class DirectDebitEmailComponent implements OnInit {
