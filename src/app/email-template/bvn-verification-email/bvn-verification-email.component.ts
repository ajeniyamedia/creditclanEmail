...
@Component({
  selector: 'app-bvn-verification-email',
  templateUrl: './bvn-verification-email.component.html',
  styleUrls: ['./bvn-verification-email.component.css'],
  animations: [
    trigger('fade', [
      transition('void => *', [
        style({ opacity: 0 }),
...
export class BvnVerificationEmailComponent implements OnInit {
