...
@Component({
  selector: 'app-validation-work-email',
  templateUrl: './validation-work-email.component.html',
  styleUrls: ['./validation-work-email.component.css'],
  animations: [
    trigger('fade', [
      transition('void => *', [
        style({ opacity: 0 }),
...
export class ValidationWorkEmailComponent implements OnInit {
