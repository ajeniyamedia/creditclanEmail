...
@Component({
  selector: 'app-card-request-email',
  templateUrl: './card-request-email.component.html',
  styleUrls: ['./card-request-email.component.css'],
  animations: [
    trigger('fade', [
      transition('void => *', [
        style({ opacity: 0 }),
...
export class CardRequestEmailComponent implements OnInit {
