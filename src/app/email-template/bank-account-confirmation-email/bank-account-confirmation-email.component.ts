...
@Component({
  selector: 'app-bank-account-confirmation-email',
  templateUrl: './bank-account-confirmation-email.component.html',
  styleUrls: ['./bank-account-confirmation-email.component.css'],
  animations: [
    trigger('fade', [
      transition('void => *', [
        style({ opacity: 0 }),
...
export class BankAccountConfirmationEmailComponent implements OnInit {
