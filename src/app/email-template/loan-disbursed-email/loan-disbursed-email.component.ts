...
@Component({
  selector: 'app-loan-disbursed-email',
  templateUrl: './loan-disbursed-email.component.html',
  styleUrls: ['./loan-disbursed-email.component.css'],
  animations: [
    trigger('fade', [
      transition('void => *', [
        style({ opacity: 0 }),
...
export class LoanDisbursedEmailComponent implements OnInit {
