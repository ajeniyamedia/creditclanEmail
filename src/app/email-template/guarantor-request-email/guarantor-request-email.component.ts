...
@Component({
  selector: 'app-guarantor-request-email',
  templateUrl: './guarantor-request-email.component.html',
  styleUrls: ['./guarantor-request-email.component.css'],
  animations: [
    trigger('fade', [
      transition('void => *', [
        style({ opacity: 0 }),
...
export class GuarantorRequestEmailComponent implements OnInit {
