...
export class CompaniesComponent implements OnInit {
  ...
  constructor(public optionsService:OptionsserviceService, public router: Router,
    public DataService:DataService,protected customersSrvc: CustomersService, 
  ...
  normalLoad(start) {
    this.action = 'normal';
    this.customersSrvc.getCompanies(0, start,this.magic_filter,this.durations,this.sectors,this.occupations,this.currentUser.token).subscribe(data => {
